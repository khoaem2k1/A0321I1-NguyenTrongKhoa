...
public class MyLinkedList<E> {
    ...
    public void addFirst(E element) {
        //khai báo 1 biến là temp trõ đến giá trị của head
        Node temp = head;
        //Biến head sẽ nhận giá trị là node mới
    ...
    public boolean remove(E element){
        //Remove đối tương nếu element head
    ...
    public MyLinkedList<E> clone(){
        ...
        Node temp = head;
        //add temp vào danh sách trả vể để nó làm head
